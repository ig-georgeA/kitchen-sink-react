...
import { IgrActionStrip, IgrActionStripModule, IgrColumn, IgrGrid, IgrGridBaseDirective, IgrGridEditDoneEventArgs, IgrGridEditingActions, IgrGridModule, IgrGridPinningActions, IgrGridToolbar, IgrGridToolbarActions, IgrGridToolbarHiding, IgrGridToolbarPinning, IgrGridToolbarTitle, IgrPaginator, IgrRowSelectionEventArgs, IgrTreeGrid, IgrTreeGridModule } from 'igniteui-react-grids';
    ...
    <>
      <div className={classes("column-layout grid-and-tree-grid-container")}>
        <div className={classes("row-layout group")}>
          ...
          <IgrTreeGrid data={iGNorthwindAPIv2EmployeeDto} primaryKey="employeeId" foreignKey="reportsTo" rowEditable="true" rowSelection="single" displayDensity="cosy" allowFiltering="true" rowSelectionChanging={(s, event) => treeGridRowSelectionChanging(s, event)} rowEditDone={employeesRowEditDone} className={classes("ig-typography ig-scrollbar list")} key={uuid()}>
            <IgrGridToolbar>
              <IgrGridToolbarTitle>
