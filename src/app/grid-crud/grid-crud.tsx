import { IgrGridEditDoneEventArgs, IgrRowDataEventArgs } from '@infragistics/igniteui-react';
import { IgrActionStrip, IgrActionStripModule, IgrColumn, IgrGrid, IgrGridBaseDirective, IgrGridEditingActions, IgrGridModule, IgrGridPinningActions, IgrGridToolbar, IgrGridToolbarActions, IgrGridToolbarAdvancedFiltering, IgrGridToolbarHiding, IgrGridToolbarPinning, IgrGridToolbarTitle } from '@infragistics/igniteui-react-grids';
  ...
  return (
    <>
      <div className={classes("row-layout grid-crud-container")}>
        <IgrGrid data={iGNorthwindAPIv2CustomerDto} primaryKey="customerId" displayDensity="cosy" rowSelection="single" rowEditable="true" moving="true" allowFiltering="true" filterMode="quickFilter" rowEditDone={customersRowEditDone} rowAdded={customersRowAdded} rowDeleted={customersRowDeleted} className={classes("ig-typography ig-scrollbar grid-plus")}>
          <IgrGridToolbar>
