...
import { IgrButton, IgrButtonModule, IgrCalendar, IgrCalendarModule, IgrCard, IgrCardActions, IgrCardHeader, IgrCardMedia, IgrCardModule, IgrIconButton, IgrIconButtonModule, IgrInput, IgrInputModule, IgrRipple, IgrRippleModule, IgrTab, IgrTabPanel, IgrTabs, IgrTabsModule } from 'igniteui-react';
import { IgrCategoryChart, IgrCategoryChartModule } from 'igniteui-react-charts';
import { IgrColumn, IgrGrid, IgrGridModule, IgrGridToolbar, IgrGridToolbarActions, IgrGridToolbarAdvancedFiltering, IgrGridToolbarTitle } from 'igniteui-react-grids';
        ...
        <div className={classes("column-layout group")}>
          <IgrTabs alignment="justify" className={classes("tabs")}>
            <IgrTabPanel className={classes("column-layout tab-item-content_3")} key={uuid()}>
              ...
              <IgrGrid data={northwindCustomers} primaryKey="customerID" displayDensity="cosy" allowFiltering="true" filterMode="excelStyleFilter" className={classes("ig-typography ig-scrollbar grid")}>
